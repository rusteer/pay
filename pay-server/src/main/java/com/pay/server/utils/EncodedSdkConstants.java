...
public class EncodedSdkConstants {
    ...
    protected static final String FENGYI = "1";
    ...
    public static final String JHTC = "22";//积汇天成
    public static final String ZPAY = "99";//掌支付
    public static final String EHOO = "98";//掌支付
    public static final String GULONG = "a98";//顾隆科技技术有限公司
    public static final String SMS360 = "qs";
