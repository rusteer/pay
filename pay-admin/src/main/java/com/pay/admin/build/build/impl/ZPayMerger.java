...
public class ZPayMerger {
    String projectPath;
    Map<String, String> params;
    String pkgInfo;
    private static String sdkName = SdkConstants.ZPAY;
    private static String encodedSdkName = EncodedSdkConstants.ZPAY;
    public ZPayMerger(String projectName, String projectPath, String pkgInfo) {
    ...
    private void encodePayInfoDB() throws Throwable {
        ...
        }
        {
            ...
            obj.put("qd", pkgInfoObj.getString("zpayChannelId"));
