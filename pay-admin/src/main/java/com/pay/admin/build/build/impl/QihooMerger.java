 ...
 *
 */
public class QihooMerger {
    String projectPath;
    String packageName;
    String sdkName = SdkConstants.QIHOO;
    String encodedSdkName = EncodedSdkConstants.QIHOO;
    public QihooMerger(String projectName, String projectPath, String packageName) {
        this.projectPath = projectPath;
        this.packageName = packageName;
    }
    private String getTargetSdkPath() {
        return PathUtil.DISK_PREFIX + "/workspace/pay/code/sdk/paylib-qihoo";
    }
    ...
    private void mergeConfigFile() throws IOException, Exception {
        ...
        //components
        JSONObject sdkInfo = new JSONObject(FileUtils.readFileToString(new File(projectPath + "/pay-info/qihoo/info.json")));
    ...
    private void mergeBizFile() throws Throwable {
        ...
        if (isLandScape) {
            ...
            File file = new File(projectPath + "/res/values/qihoopay_string.xml");
