 ...
 *
 */
public class LetuPayMerger {
    String projectPath;
    Map<String, String> params;
    String packageId;
    private static String sdkName = SdkConstants.LETU;
    private static String encodedSdkName = EncodedSdkConstants.LETU;
    public LetuPayMerger(String projectName, String projectPath, int packageId) {
