...
public class UniPayMerger {
    String projectPath;
    Map<String, String> params;
    private static String sdkName = SdkConstants.UNIPAY;
    private static String encodedSdkName = EncodedSdkConstants.UNIPAY;
    public UniPayMerger(String projectName, String projectPath) {
    ...
    private void mergeConfigFile() throws IOException, Exception {
        ...
        sdkComponents = sdkComponents.replace("#SCREEN_ORIENTATION#", getProjectInfo().getString("screenOrientation"));
