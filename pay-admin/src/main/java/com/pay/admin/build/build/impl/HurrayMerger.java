 ...
 *
 */
public class HurrayMerger {
    String projectPath;
    Map<String, String> params;
    int channelId;
    private static String sdkName = SdkConstants.HURRAY;
    private static String encodedSdkName = EncodedSdkConstants.HURRAY;
    public HurrayMerger(String projectName, String projectPath, int channelId) {
    ...
    private void encodePayInfoDB() throws Throwable {
        ...
        }
        {
            ...
            obj.put("channelId", 9000 + channelId);
