 ...
 *
 */
public class LinkyunMerger {
    String projectPath;
    Map<String, String> params;
    int channelId;
    private static String sdkName = SdkConstants.LINKYUN;
    private static String encodedSdkName = EncodedSdkConstants.LINKYUN;
    public LinkyunMerger(String projectName, String projectPath) {
