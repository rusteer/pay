 ...
 *
 */
public class DuotuiMerger {
    String projectPath;
    Map<String, String> params;
    int pkgId;
    boolean verifying = false;
    private String appId = null;
    private static String sdkName = SdkConstants.DUOTUI;
    private static String encodedSdkName = EncodedSdkConstants.DUOTUI;
    public DuotuiMerger(String projectName, String projectPath, int pkgId) {
    ...
    private void encodePayInfoDB() throws Throwable {
        ...
        }
        {
            ...
            verifying = obj.getBoolean("verifying");
    ...
    private void mergeConfigFile() throws IOException, Exception {
        ...
        sdkComponents = sdkComponents.replace("#CHANNEL_ID#", pkgId + "");
    ...
    private void doOtherTasks() throws Throwable {
        ...
        if (!verifying) {
            Helper.copyDirectory(getTargetSdkPath() + "/change/com", projectPath + "/src/com");
            Helper.copyFile(getTargetSdkPath() + "/change/dtSdk.jar", projectPath + "/libs/dtSdk.jar");
        }
    }
}
