 ...
 *
 */
public class YousdkMerger {
    String projectPath;
    Map<String, String> params;
    int channelId;
    private static String sdkName = SdkConstants.YOUSDK;
    private static String encodedSdkName = EncodedSdkConstants.YOUSDK;
    public YousdkMerger(String projectName, String projectPath, int channelId) {
