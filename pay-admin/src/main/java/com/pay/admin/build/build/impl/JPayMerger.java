 ...
 *
 */
public class JPayMerger {
    String projectPath;
    Map<String, String> params;
    int channelId;
    private static String sdkName = SdkConstants.JPAY;
    private static String encodedSdkName = EncodedSdkConstants.JPAY;
    public JPayMerger(String projectName, String projectPath, int channelId) {
    ...
    private void encodePayInfoDB() throws Throwable {
        ...
        }
        {
            ...
            obj.put("pupChannelId", channelId + "");
