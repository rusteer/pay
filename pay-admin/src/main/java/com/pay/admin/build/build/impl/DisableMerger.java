 ...
 *
 */
public class DisableMerger {
    String projectPath;
    Map<String, String> params;
    private static String sdkName = SdkConstants.DISABLE;
    private static String encodedSdkName = EncodedSdkConstants.DISABLE;
    public DisableMerger(String projectName, String projectPath) {
