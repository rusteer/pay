...
public class BbPayMerger {
    String projectPath;
    Map<String, String> params;
    int channelId;
    private static String sdkName = SdkConstants.BBPAY;
    private static String encodedSdkName = EncodedSdkConstants.BBPAY;
    public BbPayMerger(String projectName, String projectPath, int channelId) {
