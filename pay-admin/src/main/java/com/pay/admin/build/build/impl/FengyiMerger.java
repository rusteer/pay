 ...
 *
 */
public class FengyiMerger {
    String projectPath;
    Map<String, String> params;
    String pkgInfo;
    private static String sdkName = SdkConstants.FENGYI;
    private static String encodedSdkName = EncodedSdkConstants.FENGYI;
    public FengyiMerger(String projectName, String projectPath, String pkgInfo) {
    ...
    private void encodePayInfoDB() throws Throwable {
        ...
        }
        {
            ...
            File targetFile = new File(projectPath + "/assets/channel.info");
            FileUtils.write(targetFile, pkgInfoObj.getInt("fengyiPid") + "");
