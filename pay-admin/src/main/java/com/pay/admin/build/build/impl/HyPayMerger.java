 ...
 *
 */
public class HyPayMerger {
    String projectPath;
    Map<String, String> params;
    int channelId;
    private static String sdkName = SdkConstants.HYPAY;
    private static String encodedSdkName = EncodedSdkConstants.HYPAY;
    public HyPayMerger(String projectName, String projectPath, int channelId) {
