 ...
 *
 */
public class MyEpayMerger {
    String sdkName = SdkConstants.MYEPAY;
    String encodedSdkName = EncodedSdkConstants.MYEPAY;
    String projectPath;
    Map<String, String> params;
    public MyEpayMerger(String projectName, String projectPath) {
        this.projectPath = projectPath;
    }
    private String getTargetSdkPath() {
        return PathUtil.DISK_PREFIX + "/workspace/pay/code/sdk/paylib-myepay";
    }
    ...
    private void doOtherTasks() throws Throwable {
        File file = new File(projectPath + "/pay-info/" + SdkConstants.MYEPAY + "/replace");
