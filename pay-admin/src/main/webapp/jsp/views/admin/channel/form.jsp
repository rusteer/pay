...
<form class="form-horizontal" id="bizForm" method="post" action="/admin/${cmpName}/" AUTOCOMPLETE="OFF" >
	...
	<div class="control-group">
		<label class="control-label" for="discountStartCount">扣量起始数</label>
		<div class="controls">
			<input type="text" id="discountStartCount" name="discountStartCount" value="${entity.discountStartCount}" />
		</div>
	</div>			
	<div class="control-group">
