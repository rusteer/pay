...
<%
	request.setAttribute("loginName", com.pay.admin.service.framework.AccountService.getCurrentUserName());
%>
<c:if test="${not empty loginName}">
	<script>
		window.location="/admin/stat/"
	</script>
</c:if>
<!DOCTYPE html>
<html lang="en">
