									...
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-body">
											<div class="widget-main">
												...
												%>												
												<form method="post" action="/package/login">
													<fieldset>
														<label>
															<span class="block input-icon input-icon-right">
																<input type="text" class="span12 input-medium required" placeholder="用户名" name="name" value="${name}"/>
																<i class="icon-user"></i>
															</span>
														</label>
