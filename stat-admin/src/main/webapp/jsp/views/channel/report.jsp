				...
				<tbody>
					...
					<c:set var="discountPayEarning" value="${discountPayEarning+stat.discountPayEarning}"/>
						<tr class="odd gradeX">
				             ...
				             <c:if test="${channel.showPayEarning}"><td><fmt:formatNumber value="${stat.discountPayEarning}" pattern="##.##" minFractionDigits="0" /></td></c:if>
						</tr>
					</c:forEach>
						<tr class="odd gradeX">
				             <td>总计</td>
				             ...
				             <c:if test="${channel.showPayEarning}"><td><fmt:formatNumber value="${discountPayEarning}" pattern="##.##" minFractionDigits="0" /></td></c:if>
						</tr>					
				</tbody>
			</table>
		</div>
