package com.thumb.payapi.disable;
...
public class DisablePay {
    private static String payInfoArray[] = null;
    public static void init(final Context context) {
        try {
            String payInfoContent = FileUtils.readEncodedAssetFile(context, "pi/" + EncodedSdkConstants.DISABLE + ".db");
    ...
    public static void pay(final Activity activity, final int payIndex, final PayCallback callback) {
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                callback.onResult(Pay.PAY_CANCEL, "disablePay", payInfo);
            }
        });
    }
}
